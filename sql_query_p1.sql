...
--Q2. WRITE A SQL QUERY TO RETRIEVE ALL TRANSACTIONS WHERE THE CATEGORY IS 'ELECTRONICS'
--AND THE QUANTITY SOLD IS MORE THAN OR EQUAL TO 4 IN THE MONTH OF NOV-2022.
 
SELECT* FROM RETAIL_SALES WHERE CATEGORY = 'ELECTRONICS' AND QUANTITY >= 4 AND
...
SELECT
ROUND(AVG(AGE),0) AS AVERAGE_AGE_OF_CUSTOMERS
FROM RETAIL_SALES
